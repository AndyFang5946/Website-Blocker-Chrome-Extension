...
Download or create the project files in a dedicated folder.
...
📖 Usage
Click the extension icon to open the Blocker Dashboard.

Enter a keyword or domain (e.g., youtube or instagram.com).

Click Block.

The extension will immediately update your rules. Any attempt to visit these sites will redirect you to Google.

To unblock, simply click the Delete button next to the site name in the dashboard.
